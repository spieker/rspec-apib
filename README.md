...
RSpec::Apib.configure do |config|
  ...
  # By default inclusion_policy is :optin
  # If we set inclusion_policy to :all all records of type record_types
  # will be included even if apid: false

  # config.inclusion_policy = :all
end
# ...
RSpec::Apib.start
```
